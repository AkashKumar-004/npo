...
const getProjects4=()=>axios.get(`${API}/donation/all`)
...
const addProjects4=(projectdata)=>axios.post(`${API}/donation/add`,projectdata)

export { getProjects,getProjects1,getProjects2,getProjectsbyID,getProjectsbyID1,getProjectsbyID2,addProjects,addProjects1,addProjects2,addProjects3,addProjects4,getProjects3,getProjects4,getProjectsbyID3};